...
int main(int argc, char **argv){
  ...
  ths = pfft_plan_cgc_3d(n, gc_below, gc_above,
      cdata, comm_cart_2d, PFFT_GC_TRANSPOSED_NONE);
  ...
  /* check input */
  if(verbose)
    pfft_apr_complex_3d(cdata, local_ni, local_i_start, "reduced gcells", comm_cart_2d);
  ...
  err = pfft_check_output_complex_3d(n, local_ni, local_i_start, cdata, comm_cart_2d);
