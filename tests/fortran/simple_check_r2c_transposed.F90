...
!     Plan parallel forward FFT
      call dpfft_plan_dft_r2c_3d(plan_forw, n, data_in, data_out, comm_cart_2d, &
     &     PFFT_FORWARD, PFFT_TRANSPOSED_OUT + PFFT_MEASURE + PFFT_DESTROY_INPUT)
      
!     Plan parallel backward FFT
      call dpfft_plan_dft_c2r_3d(plan_back, n, data_out, data_in, comm_cart_2d, &
...
!     Scale data
      m=1
      do l=1, 2*(n(1)/2+1) * local_ni(2) * local_ni(3) 
