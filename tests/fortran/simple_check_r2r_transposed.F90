...
!     for REDFT00 N=2*(n-1), for RODFT00 N=2*(n+1), otherwise N=2*n
      ...
      kinds_forw(3) = PFFT_REDFT00; kinds_back(3) = PFFT_REDFT00;
      kinds_forw(2) = PFFT_REDFT01; kinds_back(2) = PFFT_REDFT10;
      kinds_forw(1) = PFFT_RODFT00; kinds_back(1) = PFFT_RODFT00;

      ln(3) = 2*(n(3)-1);
      ln(2) = 2*n(2);
      ln(1) = 2*(n(1)+1); 

      kinds_forw(2) = PFFT_REDFT00; kinds_back(2) = PFFT_REDFT00;
      ln(2) = 2*(n(2)-1);
...
!     n2 x n1 x n0 -> n0 x n1 x n2 -> n1 x n2 x n0 -> n0 x n2 x n1
!      kinds_forw(1) = PFFT_REDFT01; kinds_back(1) = PFFT_REDFT10;
!      ln(1) = 2*n(1);
!      kinds_forw(2) = PFFT_REDFT01; kinds_back(2) = PFFT_REDFT10;
!      ln(2) = 2*n(2);
!      kinds_forw(3) = PFFT_REDFT01; kinds_back(3) = PFFT_REDFT10;
!      ln(3) = 2*n(3);
...
!     Plan parallel forward FFT
     ...
     &     kinds_forw, PFFT_TRANSPOSED_OUT + PFFT_MEASURE + PFFT_DESTROY_INPUT)
      
!     Plan parallel backward FFT
      call dpfft_plan_r2r_3d(plan_back, n, data_out, data_in, comm_cart_2d, &
     &     kinds_back, PFFT_TRANSPOSED_IN + PFFT_MEASURE + PFFT_DESTROY_INPUT)
