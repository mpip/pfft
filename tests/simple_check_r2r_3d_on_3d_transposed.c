...
int main(int argc, char **argv)
{
  ...
  alloc_local = pfft_local_size_r2r_3d(n, comm_cart_3d, PFFT_TRANSPOSED_OUT,
  ...
  plan_forw = pfft_plan_r2r_3d(
      n, in, out, comm_cart_3d, kinds_forw, PFFT_TRANSPOSED_OUT| PFFT_MEASURE| PFFT_DESTROY_INPUT);
