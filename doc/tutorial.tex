...
\lstinputlisting[numbers=left, float, caption={Minimal parallel c2c-FFT test program.}, label=lst:min_c2c]{../tests/manual_min_c2c.c}
...
\subsection{Higher dimensional data decomposition}
...
\subsection{Preserving input data}
\begin{compactitem}
...
\subsection{FFTs with shifted index sets}
\begin{compactitem}
