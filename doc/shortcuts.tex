...
\newcommand{\fftwversion}{\textsf{3.3.2}}
\newcommand{\fftwversionsl}{\textsl{\fftwversion}}

\newcommand{\pfft}{\textsf{PFFT}}
\newcommand{\pfftversion}{1.0.5-alpha}
...
\newcommand{\fftwaversion}{3.3alpha1}
\newcommand{\fftwaversionsl}{\textsl{\fftwaversion}}

\newcommand{\ppnfft}{\textsf{P$^2$NFFT}}
\newcommand{\ppnfftcap}{\texorpdfstring{\ppnfft}{\textsf{P\texttwosuperior NFFT}}}
\newcommand{\pppm}{\textsf{P$^3$M}}
\newcommand{\pppmcap}{\texorpdfstring{\pppm}{\textsf{P\textthreesuperior M}}}
...
\IfPackageLoaded{listings}
{
  ...
  \lstset{language = C,
	morekeywords={ptrdiff_t, fftw_complex, pfft_plan, pfft_gcplan, MPI_Comm, size_t, INT,
	              PX, R, C, X, XM, complex, nfplan},
%         morekeywords={ptrdiff_t, nfft_mpi_plan, nfft_mpi_init_guru, nfft_mpi_init_nodes, MPI_Init,
%           fftw_mpi_init, MPI_Comm_size, nfft_trafo_par3d, nfft_adjoint_par3d, fftw_mpi_cleanup, MPI_Finalize, nfft_mpi_finalize, main},
  ...
  %   	prebreak = {...},
	...
	float, % Listings are float objects, doesn't work for unknown reason
	escapeinside = {(*@}{@*)}}
  % 
